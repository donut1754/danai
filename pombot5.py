...
cl.login(token="EnhU7yQUzi2KrZIF37fa.qM4RfA71y8Z1y2S2GLdQAG.Vhq8jXNcSBggo01gZ8BP7xpMKdF+KH+VaFUPuyzQUGA=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="EnFoKb4jUwnKJ1PwjB24.es8hyE+hUxj3aGoFVGl1Da.X9m+CfOiuzq/frcQkhSHuCOF8ibdn1h2IoboR6Uvj+w=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="EnAtXUIcb7zokxU8Gy8d.q54JaLG084oPKmYLdpYwpq.nIdZEiDM4l1dy8Dj7NyTk2ua75Xx+t/T50FTQM5hTZ4=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="En6PrBjeFdNasaE7Irve.FZsrnSkZffEi3s/ou5k+3G.p36QxLvwKGwc0RwYaZpRmwBRxyVdfTpi903B+NLiPgo=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="EnfkoNniKtUoimkIbaQ0.9vtjE887Sod39Kibjxxfia.htNyFK4kZg5ImcLSgHHKT9olN89LBcTYC+LB4bcXIGA=")
ks.loginResult()
...
admin=["ub3db3cc8a5db36da5186eb52d14bfaa9","u4f8709f6222b794c1f03e7e04ea20277","u531f68025e1b287f71b64588a8b11875","u4d0c7094d063ef17a32a2e0872f9901a","u6fe16c90ea1b71404b429593539bc7b3","uef8cf0ea563c34d23f986fd59fa11847","ua4829d9a978ec3833141b1d72256b7e7","ud13d496b0970c090ed4be6fac855985f"] 
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""ขอบคุณสำหรับมิตรภาพที่ดีต่อกัน
≫ ====================== ≪
≫ 💮_ⓓⓐⓝⓐⓘ_💮 ≪
...
โปรดใช้วิจารณญาณในการสั่งซื้อ
    ...
    ☆✈✈  Ľ¡Ŋ₤βΦŦ  ✈✈☆
☆  ─═हई..तุএച้ට௮..ईह═─ ☆
สนใจติดต่อ: http://line.me/ti/p/~405_pom""",
    "lang":"JP",
...
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to, "ตั้งจุดตรวจสอบ")
                try:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "||รายชื่อผู้เข้าชม||\n%s\n\n||By :─═हई..तุএച้ට௮..ईह═─ ||\n\n%s\nตั้งจุดอ่าน ณ เวลา\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "กรุณาวาง Cctv เพื่อตั้งจุด\nขอได้รับความขอบคุณจากเรา ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Bot In","กุ๊กๆๆ"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["ชิ้วๆๆ","Bot Go"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#-----------------------------------------------
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Creator By : 💮_ⓓⓐⓝⓐⓘ_💮  😜")
...
#---------------------
        if op.type == 17:
          ...
          random.choice(KAC).sendText(op.param1, "ยินดีต้อนรับสู่ บ้าน " + str(ginfo.name) + " :\nBy : " + ginfo.creator.displayName)
          #random.choice(KAC).sendText(op.param1,"Budayakan Baca Note !!! yah Ka 😊\nSemoga Betah Kk 😘")
          print "MEMBER HAS JOIN THE GROUP"
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "โอกาสหน้าเจอกันใหม่นะจร๊ คนดี ")
